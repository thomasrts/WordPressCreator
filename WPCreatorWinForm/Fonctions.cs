    ...
    public class Fonctions
    {
                                        ...
                                        try
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    MySqlConnection connection = new MySqlConnection("SERVER= 104.40.200.125; UID=Thomas; PASSWORD=#*ThomasR62");
                                                    MySqlCommand command = connection.CreateCommand();
                                                    connection.Open();
                                                    command.CommandText = "CREATE DATABASE " + prmNomBDD;
        ...
        public void CreationApache(string prmNomSite)
        {
            ...
            using (Session session = new Session()){
                ...
                transferResult =
                    session.PutFiles(@"C:\Temp\" + prmNomSite + ".conf", "/tmp/"+prmNomSite+".conf", false, transferOptions);
            ...
            using (var client = new SshClient(this.IP, 22, this.Username, this.password))
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        client.Disconnect();
                        MessageBox.Show(@"Activation du site effectuée ! Félicitations, votre site est disponible à partir de l'adresse suivante : " + prmNomSite);
